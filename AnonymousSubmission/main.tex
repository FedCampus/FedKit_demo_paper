...
\begin{tikzpicture}
    ...
    \draw[-stealth] (0.5, 0.0) node[above right]{Requests to train \model} --
                    (5.0, 0.0);
    \draw[stealth-] (0.5,-0.1) -- node[below]{FL server \fs{} to train \model}
                    (5.0,-0.1);
...
% TODO: Reorganize by data structure.
...
iOS trainer.
% TODO: There's also a library to upload models.
