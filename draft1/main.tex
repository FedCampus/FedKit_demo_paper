...
Flower \cite{beutel2020flower,mathur2021ondevice} provides SDKs for
both Android and iOS,
but has not yet achieved FL support across both platforms.
...
\begin{table}
    ...
    \begin{tabular}{lccccc}
        ...
        FL across Android/iOS& \ding{55}  & \ding{55}  & \ding{55}  & \ding{51}  & \ding{51}       \\
