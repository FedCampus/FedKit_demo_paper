...
While FedML \cite{he2020fedml}, Project Florida \cite{madrigal2023project}
and FedScale \cite{lai2022fedscale},
merely support Android, their
proprietary services cannot be self-hosted,
restricting customization options.
Moreover, Flower \cite{beutel2020flower,mathur2021ondevice} provides only
an iOS SDK,
...
However, Flower and PySyft primarily support one-shot experiments, which makes them less conducive to research iteration in
production settings.
...
\circled{1} A cross-platform (Android-iOS) FL pipeline centered; \circled{2} In-production FL customization to enable efficient FL research iteration.
