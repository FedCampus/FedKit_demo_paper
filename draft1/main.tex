...
FedKit is a client-server FL system with a Backend as the server and
apps across smartphone platforms as clients.
% TODO: Figure of system structure.
The Backend orchestrates the FL process and manages ML model data.
Clients learn local training data and exchange ML model information with
the Backend.
While the system structure is simple and elegant,
technical challenges imposed by mobile development make it very difficult to
implement.
To address these challenges and make cross-platform on-smartphone FL possible,
