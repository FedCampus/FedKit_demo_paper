...
To conduct feasible FL experiments on smartphones,
it is imperative to have a comprehensive system that
not only supports cross-platform on-device training,
but also offers the flexibility to make adjustments in production settings.
...
restricting customization options.
...
Flower and PySyft are also less conducive to research iteration in
production settings,
primarily supporting one-shot experiments.

\subsubsection{Contributions}
We developed FedKit,
a versatile FL system designed to enable cross-platform FL research on
Android and iOS:
\begin{enumerate}[label=\bullet]
    \item FedKit provides a set of modularized libraries to train
        Python-based ML models on Android and iOS and
        aggregate across platforms.
        These libraries can serve as a foundational resource or reference for
        future FL systems.
    \item We introduce a novel FL workflow within FedKit,
        enabling control over ML models and FL algorithms from
        the backend in production settings.
